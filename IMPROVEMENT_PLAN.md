...
## Mission autonomy & upfront planning (core v0.18.40+; fidelity v0.18.41+; validator pause v0.18.42+; pre-blueprint v0.18.43+; multiline submit v0.18.44+; blueprint export v0.18.45+; export + pre-Q&A v0.18.46+; copy blueprint v0.18.47+; Chat blueprint hint v0.18.48+; Settings blueprint rows v0.18.49+; Settings → VS Code `myAi.missions` v0.18.50+; Chat Mission settings button v0.18.51+)
